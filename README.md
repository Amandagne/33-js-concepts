...
3. **[Value Types fi Marsariitii Wabii Types](#3-value-types-and-reference-types)**
4. **[Implicit, Explicit, Nominal Structuring fi Duck Typing](#4-implicit-explicit-nominal-structuring-and-duck-typing)**
5. **[==, === if typeof walbira qabaa](#5--vs--vs-typeof)**
6. **[Function Scope, Block Scope fi Lexical Scope](#6-function-scope-block-scope-and-lexical-scope)**
7. **[Expression fi Statement](#7-expression-vs-statement)**
8. **[IIFE, Modules fi Namespaces](#8-iife-modules-and-namespaces)**
9. **[Message Queue fi Event Loop](#9-message-queue-and-event-loop)**
10. **[setTimeout, setInterval fi requestAnimationFrame](#10-settimeout-setinterval-and-requestanimationframe)**
11. **[JavaScript Engines](#11-javascript-engines)**
12. **[Bitwise Operators, Type Arrays fi Array Buffers](#12-bitwise-operators-type-arrays-and-array-buffers)**
13. **[DOM fi Layout Trees](#13-dom-and-layout-trees)**
14. **[Factories fi Classes](#14-factories-and-classes)**
15. **[this, call, apply fi bind](#15-this-call-apply-and-bind)**
16. **[new, Constructor, instanceof fi Instances](#16-new-constructor-instanceof-and-instances)**
17. **[Prototype Inheritance fi Prototype Chain](#17-prototype-inheritance-and-prototype-chain)**
18. **[Object.create fi Object.assign](#18-objectcreate-and-objectassign)**
19. **[map, reduce, filter](#19-map-reduce-filter)**
20. **[Pure Functions, Side Effects, State Mutation fi Event Propagation](#20-pure-functions-side-effects-state-mutation-and-event-propagation)**
21. **[Closures](#21-closures)**
22. **[High Order Functions](#22-high-order-functions)**
23. **[Recursion](#23-recursion)**
24. **[Collections fi Generators](#24-collections-and-generators)**
25. **[Promises](#25-promises)**
26. **[async/await](#26-asyncawait)**
27. **[Data Structures](#27-data-structures)**
28. **[Expensive Operation fi Big O Notation](#28-expensive-operation-and-big-o-notation)**
29. **[Algorithms](#29-algorithms)**
30. **[Inheritance, Polymorphism fi Code Reuse](#30-inheritance-polymorphism-and-code-reuse)**
31. **[Design Patterns](#31-design-patterns)**
32. **[Partial Applications, Currying, Compose fi Pipe](#32-partial-applications-currying-compose-and-pipe)**
...
**[⬆ Gara Gubbaatti Deebi'aa](#table-of-contents)**
...
- 🎥 [JavaScript Marsariitii Wabii vs Primitive Types — Academind](https://www.youtube.com/watch?v=9ooYYRLdg_g)
- 🎥 [JavaScript Primitive Types — Simon Sez IT](https://www.youtube.com/watch?v=HsbWQsSCE5Y)
- 🎥 [Value Types and Marsariitii Wabii Types in JavaScript — Programming with Mosh](https://www.youtube.com/watch?v=e-_mDyqm2oU)
...
- 📜 [Explaining Value vs. Marsariitii Wabii in Javascript — Arnav Aggarwal](https://codeburst.io/explaining-value-vs-reference-in-javascript-647a975e12a0)
- 📜 [Primitive Types & Marsariitii Wabii Types in JavaScript — Bran van der Meer](https://gist.github.com/branneman/7fb06d8a74d7e6d4cbcf75c50fec599c)
- 📜 [Value Types, Marsariitii Wabii Types and Scope in JavaScript — Ben Aston](https://medium.com/@benastontweet/lesson-1b-javascript-fundamentals-380f601ba851)
- 📜 [Back to roots: JavaScript Value vs Marsariitii Wabii — Miro Koczka](https://medium.com/dailyjs/back-to-roots-javascript-value-vs-reference-8fb69d587a18)
- 📜 [Grasp “By Value” and “By Marsariitii Wabii” in JavaScript — Léna Faure](https://hackernoon.com/grasp-by-value-and-by-reference-in-javascript-7ed75efa1293)
- 📜 [JavaScript Marsariitii Wabii and Copy Variables — Vítor Capretz](https://hackernoon.com/javascript-reference-and-copy-variables-b0103074fdf0)
- 📜 [JavaScript Primitive vs Marsariitii Wabii Values](http://www.javascripttutorial.net/javascript-primitive-vs-reference-values/)
- 📜 [JavaScript by Marsariitii Wabii vs. by Value — nrabinowitz](https://stackoverflow.com/questions/6605640/javascript-by-reference-vs-by-value)
- 📜 [JavaScript Interview Prep: Primitive vs. Marsariitii Wabii Types — Mike Cronin](https://dev.to/mostlyfocusedmike/javascript-interview-prep-primitive-vs-reference-types-3o4f)

### Viidiyoo

- 🎥 [Javascript Pass by Value vs Pass by Marsariitii Wabii — techsith](https://www.youtube.com/watch?v=E-dAnFdq8k8)
- 🎥 [JavaScript Value vs Marsariitii Wabii Types — Programming with Mosh](https://www.youtube.com/watch?v=fD0t_DKREbE)
...
- 📜 [call() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Marsariitii Wabii/Global_Objects/Function/call)
- 📜 [bind() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Marsariitii Wabii/Global_objects/Function/bind)
- 📜 [apply() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Marsariitii Wabii/Global_Objects/Function/apply)
...
- 📜 [Object.create() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Marsariitii Wabii/Global_Objects/Object/create)
- 📜 [Object.assign() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Marsariitii Wabii/Global_Objects/Object/assign)
...
- 📜 [Generator — MDN web docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Marsariitii Wabii/Global_Objects/Generator)
...
- 📜 [Promise — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Marsariitii Wabii/Global_Objects/Promise)
